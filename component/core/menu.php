...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            if ($chmenu2 >= 1 || $_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] == 'super admin' || $_SESSION['jabatan'] == 'manager') { ?>
            ...
            if ($chmenu5 >= 1 || $_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] == 'super admin' || $_SESSION['jabatan'] == 'manager') { ?>

                <li class="treeview">
                    <a href="add_beli"> <i class="glyphicon glyphicon-log-in"></i> <span>Menu Barang Masuk</span> <span class="pull-right-container"> </span> </a>
                </li>
            <?php } else {
            }
            ...
            if ($chmenu6 >= 1 || $_SESSION['jabatan'] == 'admin') { ?>
                ...
                <li class="treeview">
                    <a href="add_jual"> <i class="glyphicon glyphicon-shopping-cart"></i> <span>Menu Barang Keluar</span> <span class="pull-right-container"> </span> </a>
            ...
            if ($chmenu3 >= 1 || $_SESSION['jabatan'] == 'admin') { ?>
                ...
                <li class="treeview">
                    <a href="#"> <i class="glyphicon glyphicon-tag"></i> <span>Kategori & Brand</span> <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                        <li>
                        ...
                        <li>
                            <a href="Brand"><i class="fa fa-circle-o"></i>Data Brand</a>
                        </li>

                        <li>
                            <a href="add_Brand"><i class="fa fa-circle-o"></i>Tambah Brand</a>
                        </li>
                    </ul>
                </li>

...
$sqlx2 = "SELECT COUNT(kode) as data FROM transaksibeli";
$hasilx2 = mysqli_query($conn, $sqlx2);
$row = mysqli_fetch_assoc($hasilx2);
$datax2 = $row['data'];
...
$sqlx2 = "SELECT COUNT(kode) as data FROM transaksimasuk";
$hasilx2 = mysqli_query($conn, $sqlx2);
$row = mysqli_fetch_assoc($hasilx2);
$datax3 = $row['data'];
...
$sqlx2 = "SELECT SUM(hargajual*sisa) AS data FROM barang";
$hasilx2 = mysqli_query($conn, $sqlx2);
$row = mysqli_fetch_assoc($hasilx2);
$data35 = $row['data'];
